...
public class QuestButton : MonoBehaviour
{
    ...
    {
        gameObject.name = "Quest Button#" + id; // Change the name of GameObject.
        gameObject.GetComponentInChildren<Text>().text = title; // Change the text displayed on the button.
        this.text = text; // Remember the quest text to display in the information part of the quest log when the button is clicked.
    }
